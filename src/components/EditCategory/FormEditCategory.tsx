...
export const FormEditCategory = () => {
  const token = " eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjhjNzFlNjY5LTM4ZGYtNGRkNy04NDYwLTc4ODc2ZmM0NTNjOSIsImlhdCI6MTY4Njc5NTA4NywiZXhwIjoxNjg2ODE2Njg3fQ.bHUdQR5mZBQnW0DbRJAMVDfqyVUlFA-KS9I0_cKZ7JE";
  ...
  const onsubmit = async (data: FormProps) => {
    const headers = {
      Authorization: "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjhjNzFlNjY5LTM4ZGYtNGRkNy04NDYwLTc4ODc2ZmM0NTNjOSIsImlhdCI6MTY4Njc4MjEyNiwiZXhwIjoxNjg2ODAzNzI2fQ.rsgb091VN85JWPX-osDgnry5sAMmdy0UbuHzq8Wrcfo",
    };
